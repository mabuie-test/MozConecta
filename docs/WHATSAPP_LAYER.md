...
## Método de conexão (principal e único)
- `linked_devices_unofficial` (Linked Devices/WhatsApp Web por QR ou código de pareamento).

> Importante: este modo é **não oficial** e pode causar banimento da linha, quedas frequentes e instabilidade operacional em ambientes SaaS.
...
- disconnected_at
- last_error
- metadata_json (inclui `connection_method`, `official_channel`, `risk_notice`)
